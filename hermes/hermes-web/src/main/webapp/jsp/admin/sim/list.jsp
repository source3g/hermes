...
<body>
	<form id="queryForm" class="well form-inline " method="get" action="${pageContext.request.contextPath}/admin/sim/list/">
	...
	<div>
		<ul class="pagination">
			...
			<li>
				当前第${page.currentPage}/${page.totalPageCount}页 转到第
