...
<style type=text/css>
body {background:url(${pageContext.request.contextPath}/img/wcb.jpg)} 
				...
				<div class="span3 center login-box" style="height:330px;margin-top:20px;background-color:white;border:1px solid #CFCFCF;">
					...
					<form class="form-horizontal" action="${pageContext.request.contextPath}/adminLogin/login" method="post">
						...
						<!--  <div style="background-color:#CFCFCF;height:40px;">  -->
							<center style="margin-top:10px;"><strong style="font-size:20px;margin-top:10px;">登录</strong></center>
						 <!-- </div> --> 
						 <div title="用户名" data-rel="tooltip" class="control-group" style="margin-top:25px;margin-left:25px">  
								<strong>用户名：</strong><input
									class="input-large span10" name="username"placeholder="请输入用户名.."
									id="username" type="text"/>
							</div>  
							<div class="clearfix" style="margin-top:10px"></div>
							
							 <div title="密码" data-rel="tooltip"  class="control-group" style="margin-left:25px">
								<strong>登录密码：</strong><!-- <i class="icon-lock"></i> --><input
									class="input-large span10" name="password" id="password"placeholder="请输入密码.."
									type="password"  />
							</div> 
							...
							<div class="center">
								<button type="submit" class="btn btn-large btn-primary" style="margin-left:25px">登录</button>
							</div>
						</fieldset>
					</form>
				</div>
